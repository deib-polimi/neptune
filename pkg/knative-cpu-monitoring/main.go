...
import (
	...
	"github.com/lterrac/edge-autoscaler/pkg/knative-cpu-monitoring/pkg/scraper"
...
func main() {
	...
	cpuScraper, err := scraper.New(kubernetesClient.CoreV1().Pods, mc.MetricsV1beta1(), node)
	...
	if err = cpuScraper.Start(stopCh); err != nil {
