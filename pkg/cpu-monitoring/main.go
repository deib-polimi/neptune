...
// 	"github.com/lterrac/edge-autoscaler/pkg/cpu-monitoring/sidecar"
...
// 	pod, err := kubernetesClient.CoreV1().Pods(namespace).Get(context.TODO(), podName, metav1.GetOptions{})

// 	if err != nil {
// 		klog.Fatalf("Error getting node: %s", err.Error())
// 	}

// 	klog.Info("creating cpu scraper")

// 	cpuScraper, err := sidecar.New(podsCache.Lister().Pods, pod)
