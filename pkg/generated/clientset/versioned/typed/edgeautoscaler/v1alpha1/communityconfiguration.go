...
type CommunityConfigurationInterface interface {
	...
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.CommunityConfigurationList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CommunityConfiguration, err error)
	CommunityConfigurationExpansion
}
...
func (c *communityConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CommunityConfigurationList, err error) {
...
func (c *communityConfigurations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *communityConfigurations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
