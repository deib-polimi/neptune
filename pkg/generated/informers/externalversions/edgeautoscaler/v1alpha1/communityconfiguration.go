...
// CommunityConfigurationInformer provides access to a shared informer and lister for
// CommunityConfigurations.
type CommunityConfigurationInformer interface {
	Informer() cache.SharedIndexInformer
	Lister() v1alpha1.CommunityConfigurationLister
}
...
func (f *communityConfigurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&edgeautoscalerv1alpha1.CommunityConfiguration{}, f.defaultInformer)
}

func (f *communityConfigurationInformer) Lister() v1alpha1.CommunityConfigurationLister {
	return v1alpha1.NewCommunityConfigurationLister(f.Informer().GetIndexer())
}
