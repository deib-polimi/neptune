...
const (
	...
	// Nodes labels
	GpuNodeLabel       string = "edgeautoscaler.polimi.it/gpu"
	GpuNodeMemoryLabel string = "edgeautoscaler.polimi.it/gpu-memory"
	...
	GpuFunctionVGPU        string = "k8s.amazonaws.com/vgpu"
