...
# usage: curl -sfL https://get.k3s.io | INSTALL_K3S_VERSION=v1.19.13+k3s1 INSTALL_K3S_EXEC="server --kube-apiserver-arg=feature-gates=InPlacePodVerticalScaling=true" sh -
...
setup_binary() {
    ...
    $SUDO chown root:root ${PWD}/k3s
    $SUDO cp ${PWD}/k3s ${BIN_DIR}/k3s
}
